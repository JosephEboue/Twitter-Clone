  ...
  return (
    <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full border-r border-gray-400 pr-0 xl:pr-8">
      ...
      <div className="space-y-2 mt-4 mb-2.5 xl:ml-24">
        <Side_bar_link text="Acceuil" Icon={AiFillHome} />
        <Side_bar_link text="Explorer" Icon={BiHash} />
        <Side_bar_link text="Notifications" Icon={BsBell} />
        <Side_bar_link text="Messages" Icon={AiOutlineInbox} />
        <Side_bar_link text="Favoris" Icon={BsBookmark} />
        <Side_bar_link text="Listes" Icon={HiOutlineClipboardList} />
        <Side_bar_link text="Profil" Icon={AiOutlineUser} />
        <Side_bar_link text="Plus" Icon={HiOutlineDotsCircleHorizontal} />
      </div>
